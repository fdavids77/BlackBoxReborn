                            ...
                            object : AppLifecycleCallback() {
                                override fun beforeCreateApplication(
                                    ...
                                    try {
                                        ...
                                        // Cache the real system UID BEFORE PM proxy hooks fire.
                                        // This is the only timing window where getPackageManager()
                                        // returns the real system PM, not BlackBox's proxied PM.
                                        if (packageName != null) {
                                            top.niunaijun.blackbox.core.NativeCore.cacheRealUid(packageName)
                                        }
                                    } catch (e: Exception) {
