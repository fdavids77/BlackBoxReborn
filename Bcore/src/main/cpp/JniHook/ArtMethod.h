...
// API 35+ (Android 15) — THIS WAS MISSING, causes flags offset detection failure
static constexpr uint32_t kAccMustCountLocks    = 0x00400000;

// API 36+ (Android 16)
static constexpr uint32_t kAccReservedRefFields = 0x00800000;
